...
export default function DashboardScreen() {
  ...
  const uniqueTankNames = Array.from(
    new Set(batches.map((b) => b.tankName).filter(Boolean)),
  );
  ...
  const filteredTanks = tanks.filter(
    (tank) =>
      !tankSearch ||
      tank.name?.toLowerCase().includes(tankSearch.toLowerCase()),
  );
    ...
    >
      ...
      >
        ...
        >
          ...
          <View
            style={[styles.statsSection, { flexDirection: "row", gap: 10 }]}
          >
            {/* 1. Cảnh báo — đứng đầu */}
            <View style={styles.statCardHalf}>
              ...
              >
                ...
                />
                <Text style={styles.statLabelDark} numberOfLines={1}>
                  Cảnh báo
                </Text>
              </View>
              <Text
            ...
            <View style={styles.statCardHalf}>
              ...
              <Text
                style={[styles.statValueDark, { color: theme.colors.primary }]}
              >
                {stats.totalTanks}
              </Text>
            </View>
                  ...
                  >
                    ...
                    <View style={styles.tankStatsGrid}>
                      ...
                      <View style={[styles.gridItem, { paddingLeft: 15 }]}>
                        <Text style={styles.gridLabel}>SỐ LƯỢNG HIỆN TẠI</Text>
                        <Text style={styles.gridValue}>
        ...
        >
          <View style={styles.pickerSheet}>
            ...
            {[
              ...
              ...uniqueTankNames.map((n) => ({ label: n, value: n })),
            ].map((opt) => (
              <TouchableOpacity
                key={opt.value}
                style={[
                  styles.pickerItem,
                  tankFilter === opt.value && styles.pickerItemActive,
                ]}
                onPress={() => {
                  setTankFilter(opt.value);
              ...
              >
                <Text
                  style={[
                    ...
                    tankFilter === opt.value && styles.pickerItemTextActive,
                  ]}
                >
                  {opt.label}
                </Text>
                {tankFilter === opt.value && (
                  <Ionicons
                    name="checkmark"
                    size={16}
                    color={theme.colors.primary}
          ...
          <View style={styles.pickerSheet}>
            ...
            {STATUS_OPTIONS.map((opt) => (
              <TouchableOpacity
                ...
                style={[
                  styles.pickerItem,
                  statusFilter === opt.value && styles.pickerItemActive,
                ]}
                onPress={() => {
              ...
              >
                <Text
                  style={[
                    styles.pickerItemText,
                    statusFilter === opt.value && styles.pickerItemTextActive,
                  ]}
                >
                  {opt.label}
                </Text>
